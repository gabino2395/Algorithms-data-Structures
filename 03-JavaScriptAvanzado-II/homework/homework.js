...
//Es importante saber que en una closure se debe retornar a una function
function counter() {
  //donde aqui guardo la data de la funcion
  let count = 0;
  return function () {
    //y aqui ejecuto cosas usando data que heredo
    count++;
    return count;
  };
}
...
function cacheFunction(cb) {
  ...
  return function (arg) {
    ...
    if (obj.hasOwnProperty(arg)) {
      ...
      //     // Si el resultado no está en caché, lo calculamos y lo almacenamos
      const result = cb(arg);
      obj[arg] = result;
      return result;
    }
...
// const asteriscos = crearCadena.bind(null, "*", "*");
// const guiones = crearCadena.bind(null, "-", "-");
// const guionesBajos = crearCadena.bind(null, "_", "_");
